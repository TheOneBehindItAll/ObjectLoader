...
if os.path.exists(str(Path.home()) + "\Documents\ObjectLoader"):
    ...
    f = open(str(Path.home()) + "\Documents\ObjectLoader\Slot0.txt","x")
    f = open(str(Path.home()) + "\Documents\ObjectLoader\Slot0Name.txt", "x")
    f = open(str(Path.home()) + "\Documents\ObjectLoader\Slot1.txt", "x")
    f = open(str(Path.home()) + "\Documents\ObjectLoader\Slot1Name.txt", "x")
    f = open(str(Path.home()) + "\Documents\ObjectLoader\Slot2.txt", "x")
    f = open(str(Path.home()) + "\Documents\ObjectLoader\Slot2Name.txt", "x")
    f = open(str(Path.home()) + "\Documents\ObjectLoader\Slot3.txt", "x")
    f = open(str(Path.home()) + "\Documents\ObjectLoader\Slot3Name.txt", "x")
    f = open(str(Path.home()) + "\Documents\ObjectLoader\Slot4.txt", "x")
    f = open(str(Path.home()) + "\Documents\ObjectLoader\Slot4Name.txt", "x")
...
class OBJECT_PT_TextTool2(bpy.types.Panel):
    bl_label = "What am I doing"
    bl_idname = "OBJECT_PT_texttoolw"
    bl_space_type = 'VIEW_3D'
    bl_region_type = 'UI'
    bl_category = "AddSlots"
    ...
    def poll(self, context):
        ...
        obj = context.object
        return (obj and obj.type in {'MESH', 'LATTICE'} and (engine in self.COMPAT_ENGINES))
    ...
    def draw(self, context):
        ...
        row = layout.row()
       # row.template_list("MESH_UL_vgroups", "", ob, "properties_custom", ob.vertex_groups, "active_index", rows=rows)
...
class OBJECT_PT_TextTool(bpy.types.Panel):
    ...
    def draw(self, context):
       ...
       # row = layout.split(factor= -0.9)
        ...
        row = layout.row()
        obj = context.object
        #layout.template_list("MATERIAL_UL_matslots_example2", "", obj, "object_custom_properties", obj, "active_material_index")
...
class MATERIAL_UL_matslots_example2(bpy.types.UIList):
    ...
    def draw_item(self, context, layout, data, item, icon, active_data, active_propname):
        ...
        if self.layout_type in {'DEFAULT', 'COMPACT'}:
            ...
            if ma:
                layout.prop(ma, "name", text="Lol nerd git good", emboss=False, icon_value=icon)
            else:
                layout.label(text="Lol", translate=False, icon_value=icon)
        # 'GRID' layout type should be as compact as possible (typically a single icon!).
        elif self.layout_type == 'GRID':
            layout.alignment = 'CENTER'
            layout.label(text="Lol", icon_value=icon)
...
class WM_OT_slot_numb(bpy.types.Operator):
   ...
   # def invoke(self, context, event):
    ...
    def execute(self, context):
      ...
      #  File2 = open(str(Path.home()) + "\Documents\ObjectLoader\Slot" + str(numb) + ".txt", "r")
       # numb2 = File2.read(100)
      #  bpy.context.scene.world["ObjectSlot" + str(numb)] = str(numb2)
        File.close()
        if numb != 4:
            numb += 1
        print(numb)
...
class WM_OT_textOpBasic(bpy.types.Operator):
    ...
    bl_label = "                            FilePath"
    home = str(Path.home())
    file1 = open(str(Path.home())+"\Documents\ObjectLoader\Slot0.txt", "r")
    file2 = open(str(Path.home())+"\Documents\ObjectLoader\Slot0Name.txt", "r")
    ...
    def execute(self, context):
        ...
        home = str(Path.home())
        file1 = open(str(Path.home())+"\Documents\ObjectLoader\Slot0.txt","a")
        file1.truncate(0)
        file1.write(selected_faces)
        file1.close()

        home = str(Path.home())
        file2 = open(str(Path.home())+"\Documents\ObjectLoader\Slot0Name.txt", "a")
        file2.truncate(0)
...
class WM_OT_textOpBasic2(bpy.types.Operator):
    ...
    home = str(Path.home())
    file1 = open(str(Path.home())+"\Documents\ObjectLoader\Slot1.txt", "r")
    file2 = open(str(Path.home())+"\Documents\ObjectLoader\Slot1Name.txt", "r")
    text : bpy.props.StringProperty(name="Set your filepath", default=file1.read(100))
    text2 : bpy.props.StringProperty(name="Set the name", default=file2.read(100))
    file1.close()
    file2.close()
    ...
    def execute(self, context):
        selected_faces = self.text
        home = str(Path.home())
        file1 = open(str(Path.home())+"\Documents\ObjectLoader\Slot1.txt", "a")
        file1.truncate(0)
        file1.write(selected_faces)
        file1.close()
        ...
        file2 = open(str(Path.home())+"\Documents\ObjectLoader\Slot1Name.txt", "a")
        file2.truncate(0)
        file2.write(nameFile)
        file2.close()
        print("" + nameFile)
...
class WM_OT_textOpBasic3(bpy.types.Operator):
    ...
    bl_label = "Paste the fbx file path (No Quotation marks)"
    home = str(Path.home())
    file1 = open(str(Path.home())+"\Documents\ObjectLoader\Slot2.txt", "r")
    file2 = open(str(Path.home())+"\Documents\ObjectLoader\Slot2Name.txt", "r")
    text: bpy.props.StringProperty(name="Set your filepath", default=file1.read(100))
    text2: bpy.props.StringProperty(name="Set the name", default=file2.read(100))
    file1.close()
    file2.close()
    ...
    def execute(self, context):
        selected_faces = self.text
        home = str(Path.home())
        file1 = open(str(Path.home())+"\Documents\ObjectLoader\Slot2.txt", "a")
        file1.truncate(0)
        file1.write(selected_faces)
        file1.close()
        print("" + selected_faces)
        ...
        file2 = open(str(Path.home())+"\Documents\ObjectLoader\Slot2Name.txt", "a")
        file2.truncate(0)
        file2.write(nameFile)
        file2.close()
        print("" + nameFile)
...
class WM_OT_textOpBasic4(bpy.types.Operator):
    ...
    bl_label = "Paste the fbx file path (No Quotation marks)"
    home = str(Path.home())
    file1 = open(str(Path.home())+"\Documents\ObjectLoader\Slot3.txt", "r")
    file2 = open(str(Path.home())+"\Documents\ObjectLoader\Slot3Name.txt", "r")
    text: bpy.props.StringProperty(name="Set your filepath", default=file1.read(100))
    text2: bpy.props.StringProperty(name="Set the name", default=file2.read(100))
    file1.close()
    file2.close()
    ...
    def execute(self, context):
        selected_faces = self.text
        home = str(Path.home())
        file1 = open(str(Path.home())+"\Documents\ObjectLoader\Slot3.txt", "a")
        file1.truncate(0)
        file1.write(selected_faces)
        file1.close()
        print("" + selected_faces)
        ...
        file2 = open(str(Path.home())+"\Documents\ObjectLoader\Slot3Name.txt", "a")
        file2.truncate(0)
        file2.write(nameFile)
        file2.close()
        print("" + nameFile)
...
class WM_OT_textOpBasic5(bpy.types.Operator):
    ...
    bl_label = "Paste the fbx file path (No Quotation marks)"
    home = str(Path.home())
    file1 = open(str(Path.home())+"\Documents\ObjectLoader\Slot4.txt", "r")
    file2 = open(str(Path.home())+"\Documents\ObjectLoader\Slot4Name.txt", "r")
    text: bpy.props.StringProperty(name="Set your filepath", default=file1.read(100))
    text2: bpy.props.StringProperty(name="Set the name", default=file2.read(100))
    file1.close()
    file2.close()
    ...
    def execute(self, context):
        selected_faces = self.text
        home = str(Path.home())
        file1 = open(str(Path.home())+"\Documents\ObjectLoader\Slot4.txt", "a")
        file1.truncate(0)
        file1.write(selected_faces)
        file1.close()
        print("" + selected_faces)
        ...
        file2 = open(str(Path.home())+"\Documents\ObjectLoader\Slot4Name.txt", "a")
        file2.truncate(0)
        file2.write(nameFile)
        file2.close()
        print("" + nameFile)
...
class ImportOne(bpy.types.Operator):
    ...
    home = str(Path.home())
    file1 = open(str(Path.home())+"\Documents/ObjectLoader/Slot0Name.txt", "r")
...
class ImportTwo(bpy.types.Operator):
    ...
    home = str(Path.home())
    file1 = open(str(Path.home())+"\Documents/ObjectLoader/Slot1Name.txt", "r")
    my_path = file1.read(100)
    if my_path == "":
        my_path = "ADD OBJECT HERE"
    bl_label = my_path  # Display name in the interface.
...
class ImportThree(bpy.types.Operator):
    ...
    home = str(Path.home())
    file1 = open(str(Path.home())+"\Documents/ObjectLoader/Slot2Name.txt", "r")
    my_path = file1.read(100)
    bl_label = my_path  # Display name in the interface.
    bl_options = {'REGISTER', 'UNDO'}
...
class ImportFour(bpy.types.Operator):
    ...
    home = str(Path.home())
    file1 = open(str(Path.home())+"\Documents/ObjectLoader/Slot3Name.txt", "r")
    my_path = file1.read(100)
    bl_label = my_path  # Display name in the interface.
    bl_options = {'REGISTER', 'UNDO'}
...
class ImportFive(bpy.types.Operator):
    ...
    home = str(Path.home())
    file1 = open(str(Path.home())+"\Documents/ObjectLoader/Slot4Name.txt", "r")
    my_path = file1.read(100)
    bl_label = my_path  # Display name in the interface.
    bl_options = {'REGISTER', 'UNDO'}
...
def register():
    bpy.utils.register_class(MATERIAL_UL_matslots_example2)

    numberofslots = open(str(Path.home()) + "\Documents\ObjectLoader\SlotNumb.txt", "w")
    # numberofslots.truncate(0)
    numberofslots.write("0")

    #bpy.utils.register_class(OBJECT_PT_TextTool2)

   # file1 = open(str(Path.home()) + "\Documents\ObjectLoader\SlotNumb.txt", "r")
   # numbr = int(file1.read(100))

   # bpy.utils.register_class(USERPREF_PT_file_paths_asset_libraries2)
...
def unregister():
    bpy.utils.unregister_class(MATERIAL_UL_matslots_example2)
    ...
    #bpy.utils.unregister_class(OBJECT_PT_TextTool2)
  #  bpy.utils.unregister_class(USERPREF_PT_file_paths_asset_libraries2)
